...
namespace Content.Server._Nuclear14.Language.Systems;
...
public sealed class LanguageLearningSystem : SharedLanguageLearningSystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<N14EntitySpokeEvent>(OnEntitySpoke);
    ...
    private void OnEntitySpoke(N14EntitySpokeEvent args)
    {
