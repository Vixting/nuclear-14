...
public partial class ChatSystem
{
        ...
        )
    {
        ...
        if (emote.ChatMessages.Count != 0)
        {
            ...
            SendEntityEmote(source, action, range, nameOverride, _n14Language.GetCurrentLanguage(source), hideLog: hideLog, checkEmote: false, ignoreActionBlocker: ignoreActionBlocker);
        }
